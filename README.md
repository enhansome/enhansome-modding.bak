...
* [Limo](https://github.com/limo-app/limo) ⭐ 775 | 🐛 171 | 🌐 C++ | 📅 2025-05-03 - General purpose mod manager primarily developed for Linux with support for the Nexus Mods API and LOOT.
...
* [SpecialK](https://github.com/SpecialKO/SpecialK) ⭐ 2,073 | 🐛 153 | 🌐 C++ | 📅 2026-09-20 - Swiss Army Knife of PC gaming with features such as HDR injection, textures modding, DLL loading such as ReShade and more.
...
* [GSC](https://github.com/xensik/gsc-tool) ⭐ 325 | 🐛 10 | 🌐 C++ | 📅 2026-09-18 - Utility to compile & decompile IW engine game (Call of Duty) scripts.
...
* [Parallax Gen](https://github.com/hakasapl/ParallaxGen) ⭐ 96 | 🐛 19 | 🌐 C++ | 📅 2026-09-18 - NIF dynamic patcher to enable parallax on your entire load order.
...
* [SSE Auto Translator](https://github.com/Cutleast/SSE-Auto-Translator) ⭐ 35 | 🐛 15 | 🌐 Python | 📅 2026-09-19 - Tool to automatically find missing translations, download and create translation mods.
...
* [Norbyte's Baldur's Gate 3 Script Extender](https://github.com/Norbyte/bg3se#norbytes-baldurs-gate-3-script-extender) ⭐ 1,506 | 🐛 211 | 🌐 C++ | 📅 2026-09-16 - Baldur's Gate 3 Script Extender.
...
* [Cyber Engine Tweaks](https://github.com/maximegmd/CyberEngineTweaks) ⭐ 4,805 | 🐛 40 | 🌐 C++ | 📅 2026-05-09 - Framework to script mods using Lua with access to all the internal scripting features.
* [WolvenKit](https://github.com/WolvenKit/WolvenKit) ⭐ 1,197 | 🐛 334 | 🌐 C# | 📅 2026-09-19 - REDEngine 4 file editor designed to simplify and accelerate modding workflow.
...
* [BepInEx](https://github.com/BepInEx/BepInEx) ⭐ 8,677 | 🐛 385 | 🌐 C# | 📅 2026-09-01 - Plugin / modding framework for Unity Mono, IL2CPP and .NET framework games.
...
* [UE Viewer](https://github.com/gildor2/UEViewer) ⭐ 2,929 | 🐛 25 | 🌐 C++ | 📅 2024-03-16 - Viewer and exporter for Unreal Engine 1–4 assets.
...
* [Unreal ImGui](https://github.com/segross/UnrealImGui) ⭐ 767 | 🐛 36 | 🌐 C++ | 📅 2024-07-22 - Unreal plugin that integrates [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 76,277 | 🐛 1,227 | 🌐 C++ | 📅 2026-09-18 framework into Unreal Engine 4.
...
* [RenoDX](https://github.com/clshortfuse/renodx) ⭐ 4,275 | 🐛 97 | 🌐 HLSL | 📅 2026-09-20 - Renovation Engine for DirectX Games that uses the ReShade addon system to add/replace shaders, HDR, textures and more.
...
* [BS Manager](https://github.com/Zagrios/bs-manager) ⭐ 1,161 | 🐛 165 | 🌐 TypeScript | 📅 2026-09-19 - Beat Sabers mod manager that also manages game versions.
* [TR1X](https://github.com/LostArtefacts/TR1X) ⭐ 990 | 🐛 151 | 🌐 C | 📅 2026-09-20 - Open source re-implementation of Tomb Raider 1 (1996), along with additional enhancements and bugfixes.
...
* [Bartłomiej Duda's Tools](https://github.com/bartlomiejduda/Tools) ⭐ 215 | 🐛 7 | 🌐 Python | 📅 2026-09-15 - Set of tools to manage and modify files from many various games.
