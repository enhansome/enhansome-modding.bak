...
* [GameBanana](https://gamebanana.com) - Mod hosting since 2001.
...
* [Limo](https://github.com/limo-app/limo) ⭐ 767 | 🐛 170 | 🌐 C++ | 📅 2025-05-03 - General purpose mod manager primarily developed for Linux with support for the Nexus Mods API and LOOT.
* [Frosty Mod Manager](https://github.com/CadeEvs/FrostyToolsuite) ⭐ 750 | 🐛 21 | 🌐 C# | 📅 2024-09-26 - Mod manager for Frostbite engine games.
* [Rai Pal](https://github.com/Raicuparta/rai-pal) ⭐ 713 | 🐛 19 | 🌐 Rust | 📅 2026-08-13 - Mod manager for universal mods.
* [Arisen Studio](https://github.com/ohhsodead/arisen-studio) ⭐ 261 | 🐛 26 | 🌐 C# | 📅 2026-08-15 - Mod manager for PS3 and Xbox 360.
...
* [AMMO (Almost Manual Mod Manager)](https://github.com/cyberrumor/ammo) ⭐ 62 | 🐛 8 | 🌐 Python | 📅 2026-08-04 - Terminal based Linux mod manager for Bethesda games.
* [dmodman](https://github.com/dandels/dmodman) ⭐ 57 | 🐛 5 | 🌐 Rust | 📅 2024-12-19 - Linux TUI mod downloader & update checker for Nexus Mods.
* [Kortex Mod Manager](https://github.com/Karandra/Kortex-Mod-Manager) ⭐ 46 | 🐛 8 | 🌐 C++ | 📅 2021-12-07 - Virtualized mod management tool for Bethesda games.
* [Continuum Mod Manager](https://github.com/dasorik/continuum-mod-manager) ⭐ 21 | 🐛 5 | 🌐 C# | 📅 2025-03-17 - Game agnostic mod manager currently supporting LEGO Batman 2 DC Super Heroes & Disney Infinity 3.0.
...
* [Automatic Tool Plugin Disabler](https://www.nexusmods.com/skyrimspecialedition/mods/158346) - Plugin to define rules for automatically disabling plugins before running executables.
...
* [Download Manager](https://github.com/aglowinthefield/mo2-download-manager) ⭐ 13 | 🐛 4 | 🌐 Python | 📅 2026-01-26 - Plugin adding features to manage downloads such as batch manipulations.
...
* [Crash Log Tools](https://github.com/Exit-9B/ModOrganizer-CrashLogTools) ⭐ 6 | 🐛 2 | 🌐 Python | 📅 2022-04-19 - Plugin that provide extra functionality for the Skyrim crash logs generated by [Crash Logger](https://www.nexusmods.com/skyrimspecialedition/mods/59596).
* [Profile Assistant](https://github.com/MaskedRPGFan/Profile-Assistant) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2024-10-22 - Plugin that automatically selects a profile and enables/disables mods based on the user's VRAM, system language and screen aspect ratio.
...
* [OBody Config Merger](https://www.nexusmods.com/skyrimspecialedition/mods/133626) - Plugin to merge multiple OBody configuration files into a single file.
...
* [SpecialK](https://github.com/SpecialKO/SpecialK) ⭐ 2,009 | 🐛 147 | 🌐 C++ | 📅 2026-08-12 - Swiss Army Knife of PC gaming with features such as HDR injection, textures modding, DLL loading such as ReShade and more.
* [WorkshopDL](https://github.com/imwaitingnow/WorkshopDL) ⭐ 967 | 🐛 47 | 📅 2025-01-20 - Standalone Steam workshop GUI downloader.
...
* [FOMOD Validator CLI](https://github.com/loicreynier/fomod-validator-cli) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2025-04-21 - CLI interface for FOMOD Validator.
...
* [ENBSeries Step Mods Guide](https://stepmodifications.org/wiki/Guide:ENBSeries) - Detailed guide on ENBSeries oriented for Skyrim.
...
* [DDS.Tools](https://github.com/BoBoBaSs84/DDS.Tools) ⭐ 19 | 🐛 1 | 🌐 C# | 📅 2026-08-14 - Command line bulk PNG to DDS (and vice versa) conversion tool with duplicate detection.
...
* [DLSSTweaks](https://www.nexusmods.com/site/mods/550) - Wrapper DLL that can force DLAA onto DLSS-supported titles, along with tweaking scaling ratios & DLSS 3.1 presets.
...
* [GSC](https://github.com/xensik/gsc-tool) ⭐ 314 | 🐛 6 | 🌐 C++ | 📅 2026-07-25 - Utility to compile & decompile IW engine game (Call of Duty) scripts.
* [IW4M-Admin](https://github.com/RaidMax/IW4M-Admin) ⭐ 252 | 🐛 9 | 🌐 C# | 📅 2026-07-05 - Complete administration tool for Pluto T6, Pluto IW5, Pluto T5, Pluto T4, H1-Mod, TeknoMW3, and most Call of Duty dedicated servers.
...
* [Horizon MW](https://horizonmw.org) - MW2 & MW3 multiplayer remake in Modern Warfare Remastered (successor of H2 Multiplayer Mod).
...
* [BodySlide and Outfit Studio](https://github.com/ousnius/BodySlide-and-Outfit-Studio) ⭐ 359 | 🐛 13 | 🌐 C++ | 📅 2026-08-12 - Tool to convert, create, and customize outfits and bodies for The Elder Scrolls and Fallout.
* [PyNifly](https://github.com/BadDogSkyrim/PyNifly) ⭐ 301 | 🐛 115 | 🌐 Python | 📅 2026-08-07 - Blender addon to import/export NIF files with support for Skyrim LE, Skyrim SE, Fallout 4, Fallout New Vegas, Fallout 76, and Fallout 3.
...
* [Synthesis](https://github.com/Mutagen-Modding/Synthesis) ⭐ 345 | 🐛 187 | 🌐 C# | 📅 2026-08-12 - Framework and GUI to empower people to create mods via code instead of by hand, mainly used to create patches.
* [Spriggit](https://github.com/Mutagen-Modding/Spriggit) ⭐ 126 | 🐛 44 | 🌐 C# | 📅 2026-07-10 - Tool to facilitate converting Bethesda plugin files to a text based format that can be stored in Git.
...
* [Skyrim Linux Modder](https://github.com/AlwaysOfflineSoftware/skyrimLinuxModManager) ⭐ 15 | 🐛 0 | 🌐 Xojo | 📅 2026-05-15 - Linux native mod manager for Skyrim.
...
* [`dargh`](https://github.com/noxsidereum/dargh) ⭐ 13 | 🐛 0 | 🌐 C++ | 📅 2023-03-17 - Open source reverse-engineered port of Dynamic Animation Replacer.
...
* [Model Swapper](https://www.nexusmods.com/skyrimspecialedition/mods/136461) - SKSE framework plugin for swapping world object models, using config files.
...
* [Parallax Gen](https://github.com/hakasapl/ParallaxGen) ⭐ 76 | 🐛 28 | 🌐 C++ | 📅 2026-07-28 - NIF dynamic patcher to enable parallax on your entire load order.
...
* [SSE Auto Translator](https://github.com/Cutleast/SSE-Auto-Translator) ⭐ 30 | 🐛 12 | 🌐 Python | 📅 2026-08-09 - Tool to automatically find missing translations, download and create translation mods.
...
* [Pack SKSE Mod](https://github.com/adya/pack-skse-mod) ⭐ 11 | 🐛 2 | 🌐 PowerShell | 📅 2026-03-09 - Repository that contains workflows for building multiple variants of SKSE mods that use CMake.
...
* [MCM Helper Visualizer](https://www.nexusmods.com/skyrimspecialedition/mods/102827) - Tool to preview MCM menus without launching the game.
* [MisMatchR](https://www.nexusmods.com/skyrimspecialedition/mods/147580) - Tool to find mismatching textures in your entire load order.
...
* [Learn To Mod](https://github.com/LivelyDismay/Learn-To-Mod/blob/main/Main.md) ⭐ 144 | 🐛 0 | 📅 2026-05-29 - Collection of various modding lessons, mostly revolving around how to read, use, and edit with xEdit.
* [Animonculory Modding Resources](https://github.com/The-Animonculory/Modding-Resources) ⭐ 44 | 🐛 0 | 📅 2025-09-09 - Modding guides written for Animonculory modlists and useful for general use.
* [A Dragonborn's Fate](https://dragonbornsfate.moddinglinked.com) - Manual MO2-based modding guide for Skyrim SE.
...
* [Starfield Mod Loader](https://github.com/lVlyke/starfield-mod-loader) ⭐ 90 | 🐛 5 | 🌐 TypeScript | 📅 2026-05-07 - Simple mod manager for Starfield that supports both Steam and Game Pass versions of the game.
...
* [NFSIISE](https://github.com/zaps166/NFSIISE) ⭐ 737 | 🐛 3 | 🌐 C | 📅 2026-05-01 - Need for Speed II cross-platform wrapper with 3D acceleration and TCP protocol.
* [NFS-XtendedInput](https://github.com/xan1242/NFS-XtendedInput) ⭐ 198 | 🐛 56 | 🌐 C++ | 📅 2025-05-14 - Xinput support plugin for Black Box (Most Wanted & newer) Need for Speed games.
* [NFSU-XtendedInput](https://github.com/xan1242/NFSU-XtendedInput) ⭐ 159 | 🐛 27 | 🌐 C++ | 📅 2025-05-14 - Xinput support plugin for Need for Speed Underground & Underground 2.
* [Binary](https://github.com/NFSCO/Binary) ⭐ 47 | 🐛 0 | 🌐 C# | 📅 2024-06-15 - Tool for editing Black Box Need for Speed binary `.BIN`, `.BUN`, `.LZC` files.
...
* [MAD x VP6 x MPC x MPV x WMV Compiler](https://github.com/bluesky-dev12/MAD-x-VP6-x-MPC-x-MPV-x-WMV-Compiler) ⭐ 9 | 🐛 1 | 🌐 Rust | 📅 2025-04-20 - Compilation of tools that let's you compile WMV, MAD, VP6, MPC and MPV for Black Box games.
...
* [GAMETEST Mods](https://www.patreon.com/gametestro) - Graphics (non free) mods for NFS games and more.
...
* [LSLib](https://github.com/Norbyte/lslib) ⭐ 921 | 🐛 150 | 🌐 C# | 📅 2026-03-31 - Tools for manipulating Divinity Original Sin and Baldur's Gate 3 files.

### Baldur's Gate 3

> Everything related to Baldur's Gate 3 modding.

* [LaughingLeader's Baldur's Gate 3 Mod Manager](https://github.com/LaughingLeader/BG3ModManager) ⭐ 1,817 | 🐛 201 | 🌐 C# | 📅 2026-03-07 - Mod manager for Baldur's Gate 3.
* [Norbyte's Baldur's Gate 3 Script Extender](https://github.com/Norbyte/bg3se#norbytes-baldurs-gate-3-script-extender) ⭐ 1,493 | 🐛 206 | 🌐 C++ | 📅 2026-07-11 - Baldur's Gate 3 Script Extender.
* [BG3WASD](https://github.com/Ch4nKyy/BG3WASD) ⭐ 67 | 🐛 14 | 🌐 C++ | 📅 2026-08-02 - WASD Character Movement Mod for Baldur's Gate 3.
...
* [BG3 Mod Auto Translator](https://www.nexusmods.com/baldursgate3/mods/15778) - Tool to translate mod automatically using DeepL.
...
* [Norbyte's Divinity Script Extender](https://github.com/Norbyte/ositools) ⭐ 482 | 🐛 71 | 🌐 C++ | 📅 2026-01-14 - Divinity: Original Sin 2 script extender toolkit adding features to the scripting language of the game.
* [LaughingLeader's Divinity Mod Manager](https://github.com/LaughingLeader-DOS2-Mods/DivinityModManager) ⭐ 130 | 🐛 11 | 🌐 C# | 📅 2026-07-24 - Mod manager for Divinity: Original Sin 2 - Definitive Edition.
...
* [WolvenKit (legacy)](https://github.com/WolvenKit/WolvenKit-7) ⭐ 102 | 🐛 19 | 🌐 C# | 📅 2025-12-28 - REDEngine 3 file editor designed to simplify and accelerate modding workflow.
...
* [Cyber Engine Tweaks](https://github.com/maximegmd/CyberEngineTweaks) ⭐ 4,802 | 🐛 39 | 🌐 C++ | 📅 2026-05-09 - Framework to script mods using Lua with access to all the internal scripting features.
* [WolvenKit](https://github.com/WolvenKit/WolvenKit) ⭐ 1,181 | 🐛 342 | 🌐 C# | 📅 2026-08-14 - REDEngine 4 file editor designed to simplify and accelerate modding workflow.
...
* [`pyrpfiv`](https://github.com/gmroder/pyrpfiv) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-01-12 - Python library for parsing and manipulating GTA IV's RPF (Resource Package Format) archives.
...
* [Star Wars Republic Commando Fix](https://github.com/SWRC-Modding/CT/releases) ⭐ 221 | 🐛 0 | 🌐 C | 📅 2026-07-29 - Community SW Republic Commando mod patch that provides extra graphical fixes and other features for modern systems.
* [WorldEdit](https://github.com/PrismaticFlower/WorldEdit) ⭐ 13 | 🐛 0 | 🌐 C++ | 📅 2026-08-14 - SW Battlefront 2 (2005) WIP world editor.
...
* [AoE2 Color Modding Tool](https://github.com/TheWaveWarden/aoe2-color-tool) ⭐ 6 | 🐛 1 | 🌐 C++ | 📅 2024-07-16 - Tool to modify player colors in Age of Empires II DE.
...
* [Anno 1800 Mod Loader](https://github.com/xforce/anno1800-mod-loader) ⚠️ Archived - Mod loader for Anno 1800 that sups loading of unpacked RDA files, XML auto merging and DLL based mods.
* [Jakob's Collection - Anno 1800 Mods](https://github.com/jakobharder/anno-1800-jakobs-mods) ⭐ 49 | 🐛 4 | 📅 2025-05-05 - Collection of mods providing new tiers, products, industries and more than 300 new visual assets (custom models, variations, skins).
* [iModYourAnno](https://github.com/anno-mods/iModYourAnno) ⭐ 47 | 🐛 46 | 🌐 C# | 📅 2024-06-04 - A WIP mod manager for Anno 1800.
...
* [FerrumC](https://github.com/ferrumc-rs/ferrumc) ⭐ 2,370 | 🐛 26 | 🌐 Rust | 📅 2026-08-14 - Multithreaded reimplementation of the Minecraft server in Rust.
* [Ferium](https://github.com/gorilla-devs/ferium) ⭐ 1,414 | 🐛 68 | 🌐 Rust | 📅 2026-05-16 - CLI mod manager with support for Modrinth, CurseForge, and GitHub Releases.
* [Awesome Minecraft](https://github.com/bs-community/awesome-minecraft) ⭐ 640 | 🐛 20 | 📅 2025-08-23 - Curated list of awesome things (including mods) related to Minecraft.
* [StopModReposts](https://github.com/StopModReposts/Illegal-Mod-Sites) ⭐ 306 | 🐛 21 | 🌐 Python | 📅 2024-03-13 - List of websites that are illegally redistributing Minecraft mods.
...
* [Awesome Modrinth](https://github.com/modrinth/awesome) ⭐ 198 | 🐛 4 | 📅 2026-07-02 - Collection of awesome open-source projects which use the Modrinth API.
* [mcman](https://github.com/Senth/minecraft-mod-manager) ⭐ 77 | 🐛 30 | 🌐 Python | 📅 2025-05-15 - CLI Modrinth mod manager.
...
* [Infinity Blade II PC Port](https://archive.org/details/infinity-blade-ii-pc) - Preservation port of Infinity Blade II to Windows PC.
* [Infinity Blade III Save Editor](https://github.com/G40styBoy/Infinity-Blade-3-Save-Editor) ⚠️ Archived - Save editor focused on making edits on Unencrypted saves easy and accessible.
...
* [Hedge Mod Manager](https://github.com/thesupersonic16/HedgeModManager) ⭐ 486 | 🐛 47 | 🌐 C# | 📅 2026-07-20 - Mod manager for Hedgehog Engine games (Sonic Generations, Sonic Lost World, Sonic Frontiers).
* [Sonic Adventure Mod Manager](https://github.com/X-Hax/SA-Mod-Manager) ⭐ 155 | 🐛 26 | 🌐 C# | 📅 2026-08-07 - Mod Manager for Sonic Adventure PC games.
...
* [Marathon](https://github.com/hyperbx/Marathon) ⭐ 39 | 🐛 4 | 🌐 C# | 📅 2026-04-24 - Toolkit and library for Sonic The Hedghehog file formats.
...
* [YgoMaster](https://github.com/pixeltris/YgoMaster) ⭐ 1,341 | 🐛 4 | 🌐 C# | 📅 2026-08-07 - Master Duel offline mod with PvP LAN support.
...
* [Dueling Book Dark Material Theme](https://github.com/QuotedTF/duelingbook-dark-minimal) ⭐ 6 | 🐛 0 | 🌐 CSS | 📅 2026-05-20 - Dueling Book [Stylebot] dark material theme.
* [DBShortcuts](https://github.com/ReinUsesLisp/dbshortcuts) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2023-08-28 - Firefox/Chrome/Edge extension providing keyboard shortcuts for Dueling Book.
* [DuelingBookClient](https://github.com/H3xtia/DuelingBookClient) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2024-11-17 - Dueling Book standalone Chromium application.
...
* [BepInEx](https://github.com/BepInEx/BepInEx) ⭐ 8,405 | 🐛 381 | 🌐 C# | 📅 2026-06-28 - Plugin / modding framework for Unity Mono, IL2CPP and .NET framework games.
...
* [Runtime Unity Editor](https://github.com/ManlyMarco/RuntimeUnityEditor) ⭐ 1,104 | 🐛 9 | 🌐 C# | 📅 2026-08-04 - In-game inspector and debugging tools for applications made with Unity3D game engine.
* [ThunderKit](https://github.com/PassivePicasso/ThunderKit) ⭐ 180 | 🐛 4 | 🌐 C# | 📅 2026-07-31 - Mod project development environment for Unity and Unity games.
...
* [UE Viewer](https://github.com/gildor2/UEViewer) ⭐ 2,910 | 🐛 26 | 🌐 C++ | 📅 2024-03-16 - Viewer and exporter for Unreal Engine 1–4 assets.
* [Awesome UE4](https://github.com/terrehbyte/awesome-ue4) ⭐ 801 | 🐛 8 | 📅 2023-09-19 - Curated list of resources for working with Unreal Engine 4.
* [Unreal ImGui](https://github.com/segross/UnrealImGui) ⭐ 766 | 🐛 36 | 🌐 C++ | 📅 2024-07-22 - Unreal plugin that integrates [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 75,656 | 🐛 1,231 | 🌐 C++ | 📅 2026-08-07 framework into Unreal Engine 4.
* [repak](https://github.com/trumank/repak) ⭐ 553 | 🐛 13 | 🌐 Rust | 📅 2026-02-20 - Rust library and CLI tool for working with Unreal Engine 4 PAK files.
...
* [mod.io Unreal Engine Plugin](https://github.com/modio/modio-ue4) ⭐ 137 | 🐛 0 | 🌐 C++ | 📅 2026-07-16 - Unreal Engine 4 plugin integrating [mod.io](https://mod.io) into your game.
...
* [Chaos Compiler Collection](https://github.com/chaoticgd/ccc) ⭐ 105 | 🐛 2 | 🌐 C++ | 📅 2026-06-07 - A set of tools for reverse engineering PS2 games with `.mdebug` symbols.
...
* [XIVLauncher Actions Status](https://github.com/goatcorp/FFXIVQuickLauncher) ⭐ 3,149 | 🐛 613 | 🌐 C# | 📅 2026-02-14 - Faster custom launcher for FFXIV with auto-login, fast patching, Discord rich presence and more.
* [RenoDX](https://github.com/clshortfuse/renodx) ⭐ 1,594 | 🐛 76 | 🌐 HLSL | 📅 2026-08-15 - Renovation Engine for DirectX Games that uses the ReShade addon system to add/replace shaders, HDR, textures and more.
* [BS Manager](https://github.com/Zagrios/bs-manager) ⭐ 1,132 | 🐛 158 | 🌐 TypeScript | 📅 2026-08-13 - Beat Sabers mod manager that also manages game versions.
* [TR1X](https://github.com/LostArtefacts/TR1X) ⭐ 966 | 🐛 154 | 🌐 C | 📅 2026-08-14 - Open source re-implementation of Tomb Raider 1 (1996), along with additional enhancements and bugfixes.
* [FFNx](https://github.com/julianxhokaxhiu/FFNx) ⭐ 509 | 🐛 60 | 🌐 C++ | 📅 2026-08-14 - Next generation modding platform for Final Fantasy VII and Final Fantasy VIII.
* [Satisfactory Mod Manager](https://github.com/satisfactorymodding/SatisfactoryModManager) ⭐ 494 | 🐛 102 | 🌐 Svelte | 📅 2026-07-09 - Application handling all the steps of installing mods in Satisfactory for you.
* [Bartłomiej Duda's Tools](https://github.com/bartlomiejduda/Tools) ⭐ 209 | 🐛 7 | 🌐 Python | 📅 2026-08-05 - Set of tools to manage and modify files from many various games.
* [Halo Asset Blender Development Toolset](https://github.com/General-101/Halo-Asset-Blender-Development-Toolset) ⭐ 152 | 🐛 12 | 🌐 Python | 📅 2026-08-06 - Halo CE/H2/H3/ODST JMS/JMA/ASS file exporter for Blender.
...
* [Bombsquad Plugin Manager](https://github.com/bombsquad-community/plugin-manager) ⭐ 62 | 🐛 38 | 🌐 Python | 📅 2026-06-12 - Plugin Manager for Bombsquad 1.7+.
* [Foundry](https://github.com/ILoveAGoodCrisp/Foundry) ⭐ 58 | 🐛 1 | 🌐 Python | 📅 2026-08-14 - Blender addon supporting asset creation for Halo Reach, Halo 4 and Halo 2 Anniversary Multiplayer.
...
* [GECK::Mapper](https://github.com/JanSimek/geck-map-editor) ⭐ 44 | 🐛 12 | 🌐 C++ | 📅 2026-08-08 - Fallout 2 map editor.
...
* [Ubitunedec](https://github.com/ldeon/Ubitunedec) ⭐ 12 | 🐛 1 | 🌐 C++ | 📅 2018-06-13 - Program for decoding and exporting SPK audio files found in Ubisoft game `.dat` files.
...
* [Add-on Box](https://github.com/kinten108101/steam-vpk) ⚠️ Archived - Left for Dead 2 add-on manager for Linux.
* [Flat Out 2 Mod Manager](https://github.com/sech1p/FlatOut2ModManager) ⭐ 1 | 🐛 0 | 🌐 C# | 📅 2024-06-19
* [Balatro Mod Manager](https://balatro-mod-manager.dasguney.com) - Mod manager for Balatro.
