...
* [Limo](https://github.com/limo-app/limo) ⭐ 774 | 🐛 170 | 🌐 C++ | 📅 2025-05-03 - General purpose mod manager primarily developed for Linux with support for the Nexus Mods API and LOOT.
* [Frosty Mod Manager](https://github.com/CadeEvs/FrostyToolsuite) ⭐ 757 | 🐛 21 | 🌐 C# | 📅 2024-09-26 - Mod manager for Frostbite engine games.
* [Rai Pal](https://github.com/Raicuparta/rai-pal) ⭐ 715 | 🐛 19 | 🌐 Rust | 📅 2026-08-31 - Mod manager for universal mods.
* [Arisen Studio](https://github.com/ohhsodead/arisen-studio) ⭐ 266 | 🐛 26 | 🌐 C# | 📅 2026-09-01 - Mod manager for PS3 and Xbox 360.
...
* [dmodman](https://github.com/dandels/dmodman) ⭐ 57 | 🐛 4 | 🌐 Rust | 📅 2026-08-30 - Linux TUI mod downloader & update checker for Nexus Mods.
...
* [SpecialK](https://github.com/SpecialKO/SpecialK) ⭐ 2,039 | 🐛 150 | 🌐 C++ | 📅 2026-08-31 - Swiss Army Knife of PC gaming with features such as HDR injection, textures modding, DLL loading such as ReShade and more.
* [WorkshopDL](https://github.com/imwaitingnow/WorkshopDL) ⭐ 986 | 🐛 47 | 📅 2026-08-29 - Standalone Steam workshop GUI downloader.
...
* [DDS.Tools](https://github.com/BoBoBaSs84/DDS.Tools) ⭐ 19 | 🐛 0 | 🌐 C# | 📅 2026-08-31 - Command line bulk PNG to DDS (and vice versa) conversion tool with duplicate detection.
...
* [GSC](https://github.com/xensik/gsc-tool) ⭐ 318 | 🐛 6 | 🌐 C++ | 📅 2026-08-26 - Utility to compile & decompile IW engine game (Call of Duty) scripts.
...
* [Synthesis](https://github.com/Mutagen-Modding/Synthesis) ⭐ 346 | 🐛 192 | 🌐 C# | 📅 2026-08-21 - Framework and GUI to empower people to create mods via code instead of by hand, mainly used to create patches.
* [Spriggit](https://github.com/Mutagen-Modding/Spriggit) ⭐ 128 | 🐛 45 | 🌐 C# | 📅 2026-07-10 - Tool to facilitate converting Bethesda plugin files to a text based format that can be stored in Git.
...
* [Parallax Gen](https://github.com/hakasapl/ParallaxGen) ⭐ 76 | 🐛 32 | 🌐 C++ | 📅 2026-08-31 - NIF dynamic patcher to enable parallax on your entire load order.
...
* [SSE Auto Translator](https://github.com/Cutleast/SSE-Auto-Translator) ⭐ 32 | 🐛 14 | 🌐 Python | 📅 2026-08-25 - Tool to automatically find missing translations, download and create translation mods.
...
* [NFSIISE](https://github.com/zaps166/NFSIISE) ⭐ 746 | 🐛 4 | 🌐 C | 📅 2026-05-01 - Need for Speed II cross-platform wrapper with 3D acceleration and TCP protocol.
...
* [NFSU-XtendedInput](https://github.com/xan1242/NFSU-XtendedInput) ⭐ 164 | 🐛 28 | 🌐 C++ | 📅 2025-05-14 - Xinput support plugin for Need for Speed Underground & Underground 2.
...
* [LSLib](https://github.com/Norbyte/lslib) ⭐ 926 | 🐛 151 | 🌐 C# | 📅 2026-03-31 - Tools for manipulating Divinity Original Sin and Baldur's Gate 3 files.

### Baldur's Gate 3

> Everything related to Baldur's Gate 3 modding.

* [LaughingLeader's Baldur's Gate 3 Mod Manager](https://github.com/LaughingLeader/BG3ModManager) ⭐ 1,829 | 🐛 201 | 🌐 C# | 📅 2026-03-07 - Mod manager for Baldur's Gate 3.
* [Norbyte's Baldur's Gate 3 Script Extender](https://github.com/Norbyte/bg3se#norbytes-baldurs-gate-3-script-extender) ⭐ 1,499 | 🐛 209 | 🌐 C++ | 📅 2026-09-02 - Baldur's Gate 3 Script Extender.
...
* [WolvenKit](https://github.com/WolvenKit/WolvenKit) ⭐ 1,188 | 🐛 327 | 🌐 C# | 📅 2026-08-29 - REDEngine 4 file editor designed to simplify and accelerate modding workflow.
...
* [Star Wars Republic Commando Fix](https://github.com/SWRC-Modding/CT/releases) ⭐ 225 | 🐛 0 | 🌐 C | 📅 2026-07-29 - Community SW Republic Commando mod patch that provides extra graphical fixes and other features for modern systems.
* [WorldEdit](https://github.com/PrismaticFlower/WorldEdit) ⭐ 13 | 🐛 0 | 🌐 C++ | 📅 2026-09-01 - SW Battlefront 2 (2005) WIP world editor.
...
* [FerrumC](https://github.com/ferrumc-rs/ferrumc) ⭐ 2,394 | 🐛 26 | 🌐 Rust | 📅 2026-08-14 - Multithreaded reimplementation of the Minecraft server in Rust.
...
* [Hedge Mod Manager](https://github.com/thesupersonic16/HedgeModManager) ⭐ 491 | 🐛 50 | 🌐 C# | 📅 2026-07-20 - Mod manager for Hedgehog Engine games (Sonic Generations, Sonic Lost World, Sonic Frontiers).
* [Sonic Adventure Mod Manager](https://github.com/X-Hax/SA-Mod-Manager) ⭐ 161 | 🐛 26 | 🌐 C# | 📅 2026-08-07 - Mod Manager for Sonic Adventure PC games.
...
* [YgoMaster](https://github.com/pixeltris/YgoMaster) ⭐ 1,356 | 🐛 6 | 🌐 C# | 📅 2026-09-01 - Master Duel offline mod with PvP LAN support.
...
* [BepInEx](https://github.com/BepInEx/BepInEx) ⭐ 8,569 | 🐛 381 | 🌐 C# | 📅 2026-09-01 - Plugin / modding framework for Unity Mono, IL2CPP and .NET framework games.
...
* [Runtime Unity Editor](https://github.com/ManlyMarco/RuntimeUnityEditor) ⭐ 1,111 | 🐛 9 | 🌐 C# | 📅 2026-08-04 - In-game inspector and debugging tools for applications made with Unity3D game engine.
...
* [Unreal ImGui](https://github.com/segross/UnrealImGui) ⭐ 766 | 🐛 36 | 🌐 C++ | 📅 2024-07-22 - Unreal plugin that integrates [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 76,026 | 🐛 1,231 | 🌐 C++ | 📅 2026-09-02 framework into Unreal Engine 4.
* [repak](https://github.com/trumank/repak) ⭐ 561 | 🐛 13 | 🌐 Rust | 📅 2026-02-20 - Rust library and CLI tool for working with Unreal Engine 4 PAK files.
...
* [XIVLauncher Actions Status](https://github.com/goatcorp/FFXIVQuickLauncher) ⭐ 3,158 | 🐛 619 | 🌐 C# | 📅 2026-02-14 - Faster custom launcher for FFXIV with auto-login, fast patching, Discord rich presence and more.
* [RenoDX](https://github.com/clshortfuse/renodx) ⭐ 2,965 | 🐛 84 | 🌐 HLSL | 📅 2026-09-03 - Renovation Engine for DirectX Games that uses the ReShade addon system to add/replace shaders, HDR, textures and more.
* [BS Manager](https://github.com/Zagrios/bs-manager) ⭐ 1,146 | 🐛 161 | 🌐 TypeScript | 📅 2026-09-02 - Beat Sabers mod manager that also manages game versions.
* [TR1X](https://github.com/LostArtefacts/TR1X) ⭐ 981 | 🐛 151 | 🌐 C | 📅 2026-09-02 - Open source re-implementation of Tomb Raider 1 (1996), along with additional enhancements and bugfixes.
* [FFNx](https://github.com/julianxhokaxhiu/FFNx) ⭐ 512 | 🐛 61 | 🌐 C++ | 📅 2026-09-02 - Next generation modding platform for Final Fantasy VII and Final Fantasy VIII.
* [Satisfactory Mod Manager](https://github.com/satisfactorymodding/SatisfactoryModManager) ⭐ 497 | 🐛 105 | 🌐 Svelte | 📅 2026-08-25 - Application handling all the steps of installing mods in Satisfactory for you.
...
* [Halo Asset Blender Development Toolset](https://github.com/General-101/Halo-Asset-Blender-Development-Toolset) ⭐ 153 | 🐛 12 | 🌐 Python | 📅 2026-08-22 - Halo CE/H2/H3/ODST JMS/JMA/ASS file exporter for Blender.
...
* [Bombsquad Plugin Manager](https://github.com/bombsquad-community/plugin-manager) ⭐ 62 | 🐛 36 | 🌐 Python | 📅 2026-08-23 - Plugin Manager for Bombsquad 1.7+.
* [Foundry](https://github.com/ILoveAGoodCrisp/Foundry) ⭐ 59 | 🐛 1 | 🌐 Python | 📅 2026-08-25 - Blender addon supporting asset creation for Halo Reach, Halo 4 and Halo 2 Anniversary Multiplayer.
