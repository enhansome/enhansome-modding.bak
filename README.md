...
* [Limo](https://github.com/limo-app/limo) ⭐ 775 | 🐛 172 | 🌐 C++ | 📅 2025-05-03 - General purpose mod manager primarily developed for Linux with support for the Nexus Mods API and LOOT.
* [Frosty Mod Manager](https://github.com/CadeEvs/FrostyToolsuite) ⭐ 765 | 🐛 21 | 🌐 C# | 📅 2024-09-26 - Mod manager for Frostbite engine games.
* [Rai Pal](https://github.com/Raicuparta/rai-pal) ⭐ 718 | 🐛 13 | 🌐 Rust | 📅 2026-09-16 - Mod manager for universal mods.
...
* [AMMO (Almost Manual Mod Manager)](https://github.com/cyberrumor/ammo) ⭐ 62 | 🐛 7 | 🌐 Python | 📅 2026-09-21 - Terminal based Linux mod manager for Bethesda games.
...
* [SpecialK](https://github.com/SpecialKO/SpecialK) ⭐ 2,073 | 🐛 152 | 🌐 C++ | 📅 2026-09-21 - Swiss Army Knife of PC gaming with features such as HDR injection, textures modding, DLL loading such as ReShade and more.
* [WorkshopDL](https://github.com/imwaitingnow/WorkshopDL) ⭐ 996 | 🐛 48 | 📅 2026-08-29 - Standalone Steam workshop GUI downloader.
...
* [DDS.Tools](https://github.com/BoBoBaSs84/DDS.Tools) ⭐ 20 | 🐛 2 | 🌐 C# | 📅 2026-09-21 - Command line bulk PNG to DDS (and vice versa) conversion tool with duplicate detection.
...
* [GSC](https://github.com/xensik/gsc-tool) ⭐ 328 | 🐛 9 | 🌐 C++ | 📅 2026-09-20 - Utility to compile & decompile IW engine game (Call of Duty) scripts.
...
* [BodySlide and Outfit Studio](https://github.com/ousnius/BodySlide-and-Outfit-Studio) ⭐ 363 | 🐛 15 | 🌐 C++ | 📅 2026-09-04 - Tool to convert, create, and customize outfits and bodies for The Elder Scrolls and Fallout.
* [PyNifly](https://github.com/BadDogSkyrim/PyNifly) ⭐ 308 | 🐛 123 | 🌐 Python | 📅 2026-09-12 - Blender addon to import/export NIF files with support for Skyrim LE, Skyrim SE, Fallout 4, Fallout New Vegas, Fallout 76, and Fallout 3.
...
* [Synthesis](https://github.com/Mutagen-Modding/Synthesis) ⭐ 353 | 🐛 191 | 🌐 C# | 📅 2026-08-21 - Framework and GUI to empower people to create mods via code instead of by hand, mainly used to create patches.
...
* [Parallax Gen](https://github.com/hakasapl/ParallaxGen) ⭐ 96 | 🐛 20 | 🌐 C++ | 📅 2026-09-18 - NIF dynamic patcher to enable parallax on your entire load order.
...
* [SSE Auto Translator](https://github.com/Cutleast/SSE-Auto-Translator) ⭐ 35 | 🐛 16 | 🌐 Python | 📅 2026-09-19 - Tool to automatically find missing translations, download and create translation mods.
...
* [NFSIISE](https://github.com/zaps166/NFSIISE) ⭐ 758 | 🐛 5 | 🌐 C | 📅 2026-05-01 - Need for Speed II cross-platform wrapper with 3D acceleration and TCP protocol.
* [NFS-XtendedInput](https://github.com/xan1242/NFS-XtendedInput) ⭐ 204 | 🐛 59 | 🌐 C++ | 📅 2025-05-14 - Xinput support plugin for Black Box (Most Wanted & newer) Need for Speed games.
* [NFSU-XtendedInput](https://github.com/xan1242/NFSU-XtendedInput) ⭐ 167 | 🐛 28 | 🌐 C++ | 📅 2025-05-14 - Xinput support plugin for Need for Speed Underground & Underground 2.
...
* [Vivianne](https://github.com/TheXDS/Vivianne) ⭐ 9 | 🐛 0 | 🌐 C# | 📅 2026-09-01 - NFS 3/4 All-in-one VIV and FSH/QFS editor that aims to provide you with tools to edit textures, car performance and fedata files.
...
* [LSLib](https://github.com/Norbyte/lslib) ⭐ 934 | 🐛 151 | 🌐 C# | 📅 2026-03-31 - Tools for manipulating Divinity Original Sin and Baldur's Gate 3 files.

### Baldur's Gate 3

> Everything related to Baldur's Gate 3 modding.

* [LaughingLeader's Baldur's Gate 3 Mod Manager](https://github.com/LaughingLeader/BG3ModManager) ⭐ 1,849 | 🐛 201 | 🌐 C# | 📅 2026-03-07 - Mod manager for Baldur's Gate 3.
* [Norbyte's Baldur's Gate 3 Script Extender](https://github.com/Norbyte/bg3se#norbytes-baldurs-gate-3-script-extender) ⭐ 1,508 | 🐛 211 | 🌐 C++ | 📅 2026-09-16 - Baldur's Gate 3 Script Extender.
* [BG3WASD](https://github.com/Ch4nKyy/BG3WASD) ⭐ 68 | 🐛 9 | 🌐 C++ | 📅 2026-09-13 - WASD Character Movement Mod for Baldur's Gate 3.
...
* [Norbyte's Divinity Script Extender](https://github.com/Norbyte/ositools) ⭐ 486 | 🐛 71 | 🌐 C++ | 📅 2026-01-14 - Divinity: Original Sin 2 script extender toolkit adding features to the scripting language of the game.
...
* [Cyber Engine Tweaks](https://github.com/maximegmd/CyberEngineTweaks) ⭐ 4,804 | 🐛 40 | 🌐 C++ | 📅 2026-05-09 - Framework to script mods using Lua with access to all the internal scripting features.
* [WolvenKit](https://github.com/WolvenKit/WolvenKit) ⭐ 1,197 | 🐛 335 | 🌐 C# | 📅 2026-09-20 - REDEngine 4 file editor designed to simplify and accelerate modding workflow.
...
* [Star Wars Republic Commando Fix](https://github.com/SWRC-Modding/CT/releases) ⭐ 227 | 🐛 0 | 🌐 C | 📅 2026-09-08 - Community SW Republic Commando mod patch that provides extra graphical fixes and other features for modern systems.
...
* [iModYourAnno](https://github.com/anno-mods/iModYourAnno) ⭐ 50 | 🐛 46 | 🌐 C# | 📅 2024-06-04 - A WIP mod manager for Anno 1800.
...
* [FerrumC](https://github.com/ferrumc-rs/ferrumc) ⭐ 2,400 | 🐛 27 | 🌐 Rust | 📅 2026-08-14 - Multithreaded reimplementation of the Minecraft server in Rust.
...
* [Awesome Minecraft](https://github.com/bs-community/awesome-minecraft) ⭐ 645 | 🐛 23 | 📅 2025-08-23 - Curated list of awesome things (including mods) related to Minecraft.
* [StopModReposts](https://github.com/StopModReposts/Illegal-Mod-Sites) ⭐ 304 | 🐛 21 | 🌐 Python | 📅 2024-03-13 - List of websites that are illegally redistributing Minecraft mods.
...
* [Hedge Mod Manager](https://github.com/thesupersonic16/HedgeModManager) ⭐ 494 | 🐛 49 | 🌐 C# | 📅 2026-07-20 - Mod manager for Hedgehog Engine games (Sonic Generations, Sonic Lost World, Sonic Frontiers).
...
* [YgoMaster](https://github.com/pixeltris/YgoMaster) ⭐ 1,365 | 🐛 6 | 🌐 C# | 📅 2026-09-04 - Master Duel offline mod with PvP LAN support.
* [EDOPro Skinpack](https://github.com/Lahrenheit/EDOPRO-Skinpack) ⭐ 60 | 🐛 0 | 📅 2026-09-15 - Skin pack for EDOPro.
...
* [BepInEx](https://github.com/BepInEx/BepInEx) ⭐ 8,684 | 🐛 384 | 🌐 C# | 📅 2026-09-20 - Plugin / modding framework for Unity Mono, IL2CPP and .NET framework games.
...
* [Runtime Unity Editor](https://github.com/ManlyMarco/RuntimeUnityEditor) ⭐ 1,117 | 🐛 9 | 🌐 C# | 📅 2026-09-04 - In-game inspector and debugging tools for applications made with Unity3D game engine.
...
* [UE Viewer](https://github.com/gildor2/UEViewer) ⭐ 2,930 | 🐛 25 | 🌐 C++ | 📅 2024-03-16 - Viewer and exporter for Unreal Engine 1–4 assets.
...
* [Unreal ImGui](https://github.com/segross/UnrealImGui) ⭐ 768 | 🐛 36 | 🌐 C++ | 📅 2024-07-22 - Unreal plugin that integrates [Dear ImGui](https://github.com/ocornut/imgui) ⭐ 76,299 | 🐛 1,227 | 🌐 C++ | 📅 2026-09-18 framework into Unreal Engine 4.
* [repak](https://github.com/trumank/repak) ⭐ 570 | 🐛 13 | 🌐 Rust | 📅 2026-02-20 - Rust library and CLI tool for working with Unreal Engine 4 PAK files.
...
* [mod.io Unreal Engine Plugin](https://github.com/modio/modio-ue4) ⭐ 141 | 🐛 0 | 🌐 C++ | 📅 2026-09-16 - Unreal Engine 4 plugin integrating [mod.io](https://mod.io) into your game.
...
* [Chaos Compiler Collection](https://github.com/chaoticgd/ccc) ⭐ 107 | 🐛 3 | 🌐 C++ | 📅 2026-06-07 - A set of tools for reverse engineering PS2 games with `.mdebug` symbols.
...
* [RenoDX](https://github.com/clshortfuse/renodx) ⭐ 4,296 | 🐛 97 | 🌐 HLSL | 📅 2026-09-21 - Renovation Engine for DirectX Games that uses the ReShade addon system to add/replace shaders, HDR, textures and more.
* [XIVLauncher Actions Status](https://github.com/goatcorp/FFXIVQuickLauncher) ⭐ 3,176 | 🐛 631 | 🌐 C# | 📅 2026-02-14 - Faster custom launcher for FFXIV with auto-login, fast patching, Discord rich presence and more.
* [BS Manager](https://github.com/Zagrios/bs-manager) ⭐ 1,163 | 🐛 165 | 🌐 TypeScript | 📅 2026-09-19 - Beat Sabers mod manager that also manages game versions.
* [TR1X](https://github.com/LostArtefacts/TR1X) ⭐ 992 | 🐛 155 | 🌐 C | 📅 2026-09-21 - Open source re-implementation of Tomb Raider 1 (1996), along with additional enhancements and bugfixes.
* [FFNx](https://github.com/julianxhokaxhiu/FFNx) ⭐ 516 | 🐛 63 | 🌐 C++ | 📅 2026-09-19 - Next generation modding platform for Final Fantasy VII and Final Fantasy VIII.
* [Satisfactory Mod Manager](https://github.com/satisfactorymodding/SatisfactoryModManager) ⭐ 500 | 🐛 103 | 🌐 Svelte | 📅 2026-09-12 - Application handling all the steps of installing mods in Satisfactory for you.
* [Bartłomiej Duda's Tools](https://github.com/bartlomiejduda/Tools) ⭐ 215 | 🐛 7 | 🌐 Python | 📅 2026-09-20 - Set of tools to manage and modify files from many various games.
...
* [Bombsquad Plugin Manager](https://github.com/bombsquad-community/plugin-manager) ⭐ 61 | 🐛 36 | 🌐 Python | 📅 2026-09-12 - Plugin Manager for Bombsquad 1.7+.
...
* [GECK::Mapper](https://github.com/JanSimek/geck-map-editor) ⭐ 44 | 🐛 12 | 🌐 C++ | 📅 2026-09-17 - Fallout 2 map editor.
